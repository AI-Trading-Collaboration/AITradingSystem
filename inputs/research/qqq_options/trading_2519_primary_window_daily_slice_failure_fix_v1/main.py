...
CHART_ID = "TRADING2512_EXPORT_SAFE_DERIVED_AGGREGATES_V1"
...
class QQQOptionsPrimaryWindowDerivedAggregateCollector(QCAlgorithm):
    ...
    def _collect_session_chain(self, session, chain):
        session_id = session.isoformat()
    ...
    def on_end_of_algorithm(self):
        ...
        self._invalid_sessions.update(self._expected_sessions - self._seen_sessions)
