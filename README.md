...
当前 TRADING-074A/B/C/D/E/F/G 提供 loader/validator、配置校验、daily / weekly /
biweekly / monthly operations command graph、只读 artifact freshness checker、failure
policy evaluator 和 owner checklist builder。
...
monthly / incident owner review template。后续 dry-run、operations report、Reader Brief
operations health 和 `aits etf ops validate` 会复用该配置、freshness report、failure policy
report 和 owner checklist。
