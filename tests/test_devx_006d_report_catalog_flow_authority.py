...
def test_repository_authority_is_fresh_lossless_and_inactive() -> None:
    ...
    assert result["entry_count"] == 3107
...
def test_compatibility_authority_carries_the_inactive_shadow_contract() -> None:
    ...
    assert successor["entry_count"] == 3107
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "artifact_catalog",
            "docs/artifact_catalog.md",
            "fc9d41aa86780ed8c40d51b78c54b8e463927a16005ff18f34d0eb763a778d89",
            560,
        ),
        (
            "system_flow",
            "docs/system_flow.md",
            "330236d7f6a16d1b916ceb86e3e1d974ee58a3df5ac2a824882d04bb918a874c",
            1174,
        ),
    ],
)
