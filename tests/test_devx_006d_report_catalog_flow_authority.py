...
def test_repository_authority_is_fresh_lossless_and_inactive() -> None:
    ...
    assert result["entry_count"] == 2922
...
def test_compatibility_authority_carries_the_inactive_shadow_contract() -> None:
    ...
    assert fragment_authority["entry_count"] == 2922
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "artifact_catalog",
            "docs/artifact_catalog.md",
            "91696daf91913e04d7b5a1f5b085c3802ede2cbe5a42afa7b1948db82a3180dd",
            554,
        ),
        (
            "system_flow",
            "docs/system_flow.md",
            "ebf21cf543fd901e1b6906899984e353ee803bf21dc3d08aee06dc5c41ce3417",
            997,
        ),
    ],
)
