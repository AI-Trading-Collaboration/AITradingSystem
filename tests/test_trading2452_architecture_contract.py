...
TRADING_2491_PHASE_KEY = "phase_trading_2491_qqq_options_cross_layer_validation_harness_v1"
TRADING_2491_SUCCESSOR_CURRENT_AUTHORITY_PATHS = frozenset(
    {
        "docs/system_flow.md",
        ...
        (
            "registry/development_tasks_shadow/active/a5/"
            "a58d3f7e586cd80dc26ad94539da93033a82e76e9cc7438aebcaaab79b1ef6a0.yaml"
        ),
        (
            "registry/development_tasks_shadow_v2/a5/"
            "a58d3f7e586cd80dc26ad94539da93033a82e76e9cc7438aebcaaab79b1ef6a0.yaml"
        ),
...
def _assert_historical_source_is_current_or_superseded(
    ...
    *,
    ...
    if source_path in TRADING_2491_SUCCESSOR_CURRENT_AUTHORITY_PATHS:
        section_ids = list(baseline)
        assert TRADING_2491_PHASE_KEY in section_ids
        assert section_ids.index(section_key) <= section_ids.index(TRADING_2491_PHASE_KEY)
        return
