...
def test_arch_004_compatibility_baseline_freezes_surface_and_core_hashes() -> None:
    ...
    assert (
        migration_g2_4cw3["exact_backfill_matrix_ab_scorecard_near_miss_lineage_required"]
        is True
    )
    ...
    phase_g2_4cx2 = baseline[
        "phase_g2_4cx2_etf_cli_dynamic_v3_micro_search_foundation"
    ]
    ...
    assert (
        migration_g2_4cx2[
            "historical_calculation_and_current_quality_cache_roles_required"
        ]
        is True
    )
