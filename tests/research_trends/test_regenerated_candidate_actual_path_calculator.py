...
def test_calculator_computes_forward_path_metrics(tmp_path: Path) -> None:
...
def test_calculator_marks_partial_coverage_warning(tmp_path: Path) -> None:
    price_path = write_price_fixture(tmp_path)
    matrix = load_actual_price_matrix(price_path, "QQQ")
...
def test_calculator_below_coverage_threshold_ineligible(tmp_path: Path) -> None:
    price_path = write_price_fixture(tmp_path)
    matrix = load_actual_price_matrix(price_path, "QQQ")
