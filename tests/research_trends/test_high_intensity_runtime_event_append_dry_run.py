...
def test_event_append_dry_run_would_append_new_event() -> None:
    rows = build_high_intensity_runtime_event_append_dry_run_result(
...
def test_event_append_dry_run_deduplicates_prior_trigger_day() -> None:
    rows = build_high_intensity_runtime_event_append_dry_run_result(
        detection_rows=sample_detection_rows(),
        prior_trigger_day_rows=[
            {
...
def test_event_append_dry_run_extends_open_cluster() -> None:
...
def test_event_append_dry_run_does_not_mutate_prior_event_log() -> None:
    prior_events = [
        {
