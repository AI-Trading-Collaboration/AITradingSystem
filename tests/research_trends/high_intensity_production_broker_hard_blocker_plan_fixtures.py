...
def build_high_intensity_production_broker_hard_blocker_plan_fixture(
    tmp_path: Path,
) -> dict[str, Path]:
    fixture = build_high_intensity_paper_shadow_scope_plan_fixture(tmp_path)
    paper_shadow_scope_dir = tmp_path / "paper_shadow_scope_plan"
    paper_shadow_scope_docs_root = tmp_path / "paper_shadow_scope_docs"
    run_high_intensity_risk_cap_observe_only_paper_shadow_scope_plan(
        ...
        output_dir=paper_shadow_scope_dir,
        docs_root=paper_shadow_scope_docs_root,
    )
    return {
        **fixture,
        "paper_shadow_scope_dir": paper_shadow_scope_dir,
        "paper_shadow_scope_docs_root": paper_shadow_scope_docs_root,
    }
