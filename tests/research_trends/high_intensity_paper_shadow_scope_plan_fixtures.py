...
def build_high_intensity_paper_shadow_scope_plan_fixture(
    tmp_path: Path,
) -> dict[str, Path]:
    fixture = build_high_intensity_outcome_binding_contract_plan_fixture(tmp_path)
    outcome_binding_dir = tmp_path / "outcome_binding_plan"
    outcome_binding_docs_root = tmp_path / "outcome_binding_docs"
    run_high_intensity_risk_cap_observe_only_outcome_binding_contract_plan(
        ...
        output_dir=outcome_binding_dir,
        docs_root=outcome_binding_docs_root,
    )
    return {
        **fixture,
        "outcome_binding_dir": outcome_binding_dir,
        "outcome_binding_docs_root": outcome_binding_docs_root,
    }
