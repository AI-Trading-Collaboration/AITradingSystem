...
- 不因 Wave14 domain完成自动进入G5、ARCH-004H或ARCH-005 S5；必须先完成S2 generated/formal/Full
  与closeout，Wave15仍只允许D0B3+G4B first consumer和G3 close；旧G2.5 rehearsal不可复用为授权；
