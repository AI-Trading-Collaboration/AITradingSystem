...
|阶段|状态|内容|验收标准|
|---|---|---|---|
|1|VALIDATING|Documentation contract 生成器与 CLI|`aits docs report-contract --as-of YYYY-MM-DD` 写出 Markdown/JSON；JSON 固定 `production_effect=none`；缺文档覆盖 fail closed；目标测试覆盖 PASS 和 FAIL。|
