...
- 2026-07-13：ARCH-004 G2.4CG完成TRADING-194～198 hardening，状态转为`BASELINE_DONE / G2.4_CONTINUES`。Plan/Trigger/Capture/Ledger/Weekly共15 callback已迁canonical interface；五类`*.v2` snapshot和validator覆盖reviewed policy、timezone cutoff、pre-output DQ、live config/cache recompute、Trigger→Tag→Backfill→Compare exact lineage、semantic cutoff source selection及distinct source-event去重，并逐byte重建全部views。累计focused 606、当前slice+CLI 117、architecture 268、contract 203并行通过；Root=`21,286/612/573`，generated=`899/1,114/858/0 violations`。显式DQ skip仅测试夹具并披露；固定research-only/no-auto/no-policy/no-broker/`production_effect=none`，不触发phase handoff。
