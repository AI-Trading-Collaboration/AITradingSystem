...
- 当前已有 4 个 PIT as-of 的 historical multi-stage trace（2026-05-29、2026-06-05、2026-06-12、2026-06-18），可用于 validation-stage multi-date masking/casebook/ablation smoke；但仍低于 historical stability 诊断建议的 20 个日期。Gate availability audit 覆盖 2026-04-24～2026-06-18 共 8 个日期，其中 full advisory trace eligible=3、component validation trace eligible=7、partial component-only=4；更早 2026-04-24、2026-05-01、2026-05-08、2026-05-15 被 SEC PIT feature availability gate fail-closed，2026-06-18 缺 historical gate audit 目录而不能确认 full advisory equivalence。因此不得把 masking ratio 或 ablation 差异解释为独立因果结论。
