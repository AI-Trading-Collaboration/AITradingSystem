...
- 2026-07-20：ARCH-005 S4 证据 lane 发现 restart policy 格式化后的 source fingerprint 与旧 R0
  artifact 不一致，门禁按预期 fail closed。完整重建 R0/R1/R2 后，walk-forward id=
  `r1-wf_6447beb5464bad37`、robustness id=`r1-robustness_8c93b0e2615d0ace`、R2 id=
  `r2-decision_c761da11538fc58c`，所有 validator PASS；业务结果保持
  `CONTINUE_EVIDENCE_CLOSURE`，没有修改候选、阈值或策略结论。
