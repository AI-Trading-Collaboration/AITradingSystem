...
flowchart TD
    ...
    T066REP --> T064RIDX
    T066OVR --> T064RIDX
    T064RIDX --> T064READ["aits reports reader-brief<br/>ETF Calibration + ETF Forward + AI Confirmation<br/>latest artifacts / safety status / detail links"]
