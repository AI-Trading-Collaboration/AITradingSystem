...
flowchart TD
    subgraph Source["数据输入"]
        ...
        SEPSO["config/sec_pit_shadow_observe.yaml<br/>TRADING-044 observe-only lane、candidate approval、weight 上限、安全门禁、monitoring bucket 和 rollback 条件<br/>production_effect=none"]
