...
flowchart TD
    ...
    ETFV3FAIL --> ETFRIDX
    ETFV3FAIL --> ETFREAD
    ETFV3FAIL --> ETFV3SWEEP["aits etf dynamic-v3-rescue sweep-config/sweep/candidate/walk-forward/robustness/shadow/artifacts/promotion<br/>Constrained parameter research + observe-only shadow registry + manual promotion pack<br/>reports/etf_portfolio/dynamic_v3_rescue/sweeps|walk_forward|robustness|shadow|promotion/..."]
    ETFV3SWEEP --> ETFRIDX
    ETFV3SWEEP --> ETFREAD
