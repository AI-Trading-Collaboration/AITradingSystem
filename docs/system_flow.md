...
flowchart TD
    ...
    subgraph PaperTrading["Paper Trading Engine MVP"]
        ...
        TEQUALR["outputs/reports/paper_signal_quality_YYYY-MM-DD.json/md<br/>evaluation_gate、strategy/symbol/reason/blocked/confidence/source 聚合；observe-only；production_effect=none"]
    end
