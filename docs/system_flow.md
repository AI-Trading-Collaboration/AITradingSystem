...
flowchart TD
    ...
    T074DGRAPH --> T074NEXT["future TRADING-074E-K<br/>freshness checks / dry-run / ops report / Reader Brief ops health / validation gate"]
    T074WGRAPH --> T074NEXT
    T074SGRAPH --> T074NEXT
    T074MANUAL --> T074NEXT
```
