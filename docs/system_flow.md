...
flowchart TD
    ...
    subgraph Cache["本地缓存"]
        ...
        SECPITPAN["data/processed/sec_edgar/mapped_metrics_long.csv<br/>fundamental_pit_intervals.csv / daily panel / sec_pit_feature_panel.csv<br/>保留 SEC provenance 和 source_lineage"]
