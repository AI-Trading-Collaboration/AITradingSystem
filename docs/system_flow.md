...
flowchart TD
    ...
    T065WEEK --> T064RIDX
    T065WATCH --> T064RIDX
    T064RIDX --> T064READ["aits reports reader-brief<br/>ETF Calibration Experiments + ETF Forward Simulation<br/>latest pack / active shadow / forward dashboard / watchlist / safety status"]
