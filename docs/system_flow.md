...
flowchart TD
    ...
    T074FAIL --> T074NEXT["future TRADING-074G-K<br/>owner checklist / dry-run / ops report / Reader Brief ops health / validation gate"]
    T074MANUAL --> T074NEXT
```
