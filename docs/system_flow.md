...
flowchart TD
    ...
    subgraph Feedback["反馈校准"]
        ...
        RBRIEFR["outputs/reports/reader_brief_YYYY-MM-DD.html/json<br/>Narrative Executive Summary 含 research governance / promotion status；HTML 首屏 summary cards、status badges、market proxy cards、funnel flow、binding gate 高亮、impact/manual review 分区；保留 details 审计；production_effect=none"]
