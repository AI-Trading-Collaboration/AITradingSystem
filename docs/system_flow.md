...
flowchart TD
    ...
    EXTSHADOW["aits reports extended-shadow-protocol<br/>TRADING-381 strict extended paper-shadow eligibility<br/>no stale blocker + no safety warnings + weekly/cost/benchmark/owner/lineage + observation clock<br/>read-only / no live approval / production_effect=none"]
...
flowchart TD
    ...
    subgraph Feedback["反馈校准"]
        ...
        EXTSHADOW["aits reports extended-shadow-protocol / validate-extended-shadow-protocol<br/>TRADING-381 strict extended paper-shadow eligibility<br/>stale/safety/weekly/cost/benchmark/owner/lineage/clock checks"]
