...
flowchart TD
    ...
    T074FRESH --> T074NEXT["future TRADING-074F-K<br/>failure policy / dry-run / ops report / Reader Brief ops health / validation gate"]
    T074MANUAL --> T074NEXT
```
