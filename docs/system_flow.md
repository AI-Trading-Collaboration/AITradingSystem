...
flowchart TD
    ...
    T074DGRAPH --> T074NEXT["future TRADING-074C-K<br/>weekly/monthly graph / freshness checks / dry-run / ops report / Reader Brief ops health / validation gate"]
    T074WEEKLY --> T074NEXT
    T074SLOW --> T074NEXT
    T074MANUAL --> T074NEXT
```
