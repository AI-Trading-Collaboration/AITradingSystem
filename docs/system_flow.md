...
flowchart TD
    ...
    T074DGRAPH --> T074NEXT["future TRADING-074D-K<br/>monthly/biweekly graph / freshness checks / dry-run / ops report / Reader Brief ops health / validation gate"]
    T074WGRAPH --> T074NEXT
    T074SLOW --> T074NEXT
    T074MANUAL --> T074NEXT
```
