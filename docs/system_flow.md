...
flowchart TD
    ...
    T067EXP --> T064RIDX
    T067VAL --> T064RIDX
    T064RIDX --> T064READ["aits reports reader-brief<br/>ETF Calibration + ETF Forward + AI Confirmation + Satellite Replacement<br/>latest artifacts / safety status / detail links"]
