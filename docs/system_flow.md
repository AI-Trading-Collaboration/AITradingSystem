...
flowchart TD
    ...
    subgraph Cache["本地缓存"]
        ...
        SECPITEVAL["aits sec-pit evaluate<br/>先运行 validate_data_cache，再做 available_time gate、coverage、IC/RankIC、top-bottom spread、signal attribution 和 shadow/research/downweight/excluded 分层"]
        ...
        SECPITCMPR["outputs/sec_pit_baseline_comparison/*<br/>summary JSON/Markdown、decision impact CSV、rank shift CSV、incremental alpha CSV、run.log<br/>manual_review_required=true / production_effect=none"]
