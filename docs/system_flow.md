...
flowchart TD
    ...
    P1P --> T079DIAG["aits etf weight-calibration diagnostics --include-robust-packs<br/>historical_weight_search_diagnostics_*.json/md + stable_shapes/near_shadow CSV<br/>multi-preset stability + near-shadow rescue; no gate relaxation"]
