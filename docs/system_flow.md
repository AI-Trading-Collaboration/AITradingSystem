...
flowchart TD
    ...
    ETFDQG --> ETFEVD
    ETFEVD --> ETFREAD["aits reports reader-brief<br/>Report Navigation / ETF Backtest Summary / Task Cadence Calendar / ETF Data Quality / Strategy Evidence 只读下钻 ETF artifacts"]
    ETFDQG --> ETFREAD
    ETFRIDX --> ETFREAD
```
