...
flowchart TD
    ...
    subgraph PaperTrading["Paper Trading Engine MVP"]
        ...
        TEWSCIN["data/derived/weight_iterations/shadow/current_shadow_weights.json + candidates/shadow_weight_candidate_YYYY-MM-DD.json<br/>018C 只读输入：shadow current weights 与 018B candidate；production_effect=none"]
