...
flowchart TD
    ...
    T071REP --> T064RIDX
    T071VAL --> T064RIDX
    T064RIDX --> T064READ["aits reports reader-brief<br/>Weekly Portfolio Review + Portfolio Decision Journal + ETF Parameter Review + ETF Weight Calibration + ETF Calibration + ETF Forward + AI Confirmation + AI Attribution + Satellite Replacement<br/>latest artifacts / safety status / detail links"]
