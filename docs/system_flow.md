...
flowchart TD
    ...
    subgraph Cache["本地缓存"]
        ...
        SECPITMONR["outputs/sec_pit_shadow_monitor/*<br/>monitor summary JSON/Markdown、rolling metrics CSV、warning events CSV<br/>manual_review_required=true / production_effect=none"]
