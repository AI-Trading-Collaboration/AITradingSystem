...
flowchart TD
    ...
    T064ENR --> T064RIDX
    T064WEEK --> T064RIDX
    T064RIDX --> T064READ["aits reports reader-brief<br/>ETF Calibration Experiments<br/>latest pack / top candidate / rejected count / active shadow / safety status"]
