...
flowchart TD
    ...
    subgraph Feedback["反馈校准"]
        ...
        RBRIEFR["outputs/reports/reader_brief_YYYY-MM-DD.html/json<br/>Narrative Executive Summary 含 research governance / promotion status、Missing/Limited Artifact Impact、market panel、Score & Decision Funnel details、Task Cadence Calendar、dedup grouped Report Navigation、Data/PIT safety、research governance、documentation contract 和 grouped manual review queue；production_effect=none"]
