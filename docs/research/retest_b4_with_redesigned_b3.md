# Retest B4 With Redesigned B3

- Status: B4_REDESIGNED_RETEST_BLOCKED_NO_VALID_B3
...
- Key Result: B4_REDESIGNED_RETEST_BLOCKED_NO_VALID_B3
- Blocking Issues: B4_REDESIGNED_RETEST_BLOCKED_NO_VALID_B3
