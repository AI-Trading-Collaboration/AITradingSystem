# First-Layer V2 Coverage Policy Actual-Path Matrix

- 状态：`FIRST_LAYER_V2_COVERAGE_POLICY_ACTUAL_PATH_READY_PROMOTION_BLOCKED`
...
- policy_count: `5`
- coverage_aware_selection_pass_count: `0`
- same_risk_comparison_reported: `True`
