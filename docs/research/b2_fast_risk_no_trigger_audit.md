...
- Summary: Rapid-drawdown and volatility-spike no-trigger behavior is audited without tuning.
- Key Result: B2_FAST_RISK_NOT_SUPPORTED_BY_CURRENT_DESIGN
