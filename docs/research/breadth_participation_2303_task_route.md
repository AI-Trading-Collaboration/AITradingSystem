...
|---|---|---|---|---|
|`qqq_breadth_participation_v1`|`strict_pit_historical_constituents`|`BLOCKED_NO_RELIABLE_DATA`|`research_design_only`|`TRADING-2303_Breadth_Data_Source_Decision`|
...
|`cross_asset_breadth_quality_v1`|`pit_approximation_historical_constituents`|`BLOCKED_NO_RELIABLE_DATA`|`offline_diagnostics`|`TRADING-2303_Breadth_Data_Source_Decision`|
