...
|2|`ai_semiconductor_leadership`|80|P1|`TRADING-2307_AI_SEMICONDUCTOR_LEADERSHIP_CANDIDATE_FAMILY_FEASIBILITY_AUDIT`|
|3|`liquidity_rates_pressure`|77|P1/P2|`TRADING-2311_LIQUIDITY_RATES_PRESSURE_DATA_FEASIBILITY_AUDIT`|
|4|`regime_state_machine`|72|P2|`TRADING-2315_REGIME_STATE_MACHINE_DESIGN_AUDIT`|
|5|`event_calendar_gating`|65|P2|`TRADING-2318_EVENT_CALENDAR_DATA_FEASIBILITY_AUDIT`|
|6|`execution_cooldown_decay_cap_mechanics`|69|P0.5/P2|`TRADING-2321_RISK_CAP_COOLDOWN_DECAY_DESIGN`|
