...
```json
{
  "after": {
    ...
    "remediation_status": "GROWTH_TILT_TOP3_CANDIDATE_PIT_REPLAY_ENGINE_REMEDIATION_BLOCKED",
  ...
  "before": {
    ...
    "forward_aging_status": "GROWTH_TILT_FORWARD_AGING_CANDIDATE_PACK_BLOCKED_BY_PIT_REPLAY_GATE",
    "pit_candidates_tested": 0,
    "pit_replay_blocked_count": 3,
    "pit_replay_status": "GROWTH_TILT_TOP3_CANDIDATE_PIT_REPLAY_BLOCKED_BY_REPLAY_ENGINE_GAP",
    "promotion_review_status": "GROWTH_TILT_PAPER_SHADOW_CANDIDATE_PROMOTION_REVIEW_BLOCKED_BY_FORWARD_AGING_GATE"
  },
  "broker_action": "none",
  ...
  "schema_version": "growth_tilt_top3_candidate_pit_replay_engine_remediation_before_after.v1",
