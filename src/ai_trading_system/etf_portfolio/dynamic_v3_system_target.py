...
def _call_smoothed_method(name: str, *args: Any, **kwargs: Any) -> dict[str, Any]:
    # ARCH-004 G2.4CN compatibility surface. The lazy import avoids a module
    # cycle while preserving historical Python callers during migration.
    from ai_trading_system.etf_portfolio import dynamic_v3_system_target_smoothed_method

    try:
        return getattr(dynamic_v3_system_target_smoothed_method, name)(*args, **kwargs)
    except DynamicV3SystemTargetError:
        raise
    except ValueError as exc:
        raise DynamicV3SystemTargetError(str(exc)) from exc
...
def load_smoothed_limited_config(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("load_smoothed_limited_config", *args, **kwargs)


def validate_smoothed_limited_config(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("validate_smoothed_limited_config", *args, **kwargs)


def build_smoothed_limited_config_report(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("build_smoothed_limited_config_report", *args, **kwargs)


def smoothed_limited_config_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("smoothed_limited_config_report_payload", *args, **kwargs)


def generate_smoothed_limited_target(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("generate_smoothed_limited_target", *args, **kwargs)


def smoothed_limited_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("smoothed_limited_report_payload", *args, **kwargs)


def validate_smoothed_limited_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("validate_smoothed_limited_artifact", *args, **kwargs)


def run_smoothed_backfill(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("run_smoothed_backfill", *args, **kwargs)


def smoothed_backfill_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("smoothed_backfill_report_payload", *args, **kwargs)


def validate_smoothed_backfill_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("validate_smoothed_backfill_artifact", *args, **kwargs)


def run_smoothed_comparison(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("run_smoothed_comparison", *args, **kwargs)


def smoothed_comparison_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("smoothed_comparison_report_payload", *args, **kwargs)


def validate_smoothed_comparison_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("validate_smoothed_comparison_artifact", *args, **kwargs)


def build_smoothed_review_pack(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("build_smoothed_review_pack", *args, **kwargs)


def smoothed_review_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_method("smoothed_review_report_payload", *args, **kwargs)


def validate_smoothed_review_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
...
def _call_smoothed_readiness(name: str, *args: Any, **kwargs: Any) -> dict[str, Any]:
    # ARCH-004 G2.4CP compatibility surface.
    from ai_trading_system.etf_portfolio import (
        dynamic_v3_system_target_smoothed_readiness,
    )

    try:
        return getattr(dynamic_v3_system_target_smoothed_readiness, name)(*args, **kwargs)
    except DynamicV3SystemTargetError:
        raise
    except ValueError as exc:
        raise DynamicV3SystemTargetError(str(exc)) from exc
...
def _call_smoothed_operations(name: str, *args: Any, **kwargs: Any) -> dict[str, Any]:
    from ai_trading_system.etf_portfolio import (
        dynamic_v3_system_target_smoothed_operations as canonical,
    )

    return getattr(canonical, name)(*args, **kwargs)


def update_smoothed_forward_progress(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("update_smoothed_forward_progress", *args, **kwargs)


def smoothed_forward_progress_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("smoothed_forward_progress_report_payload", *args, **kwargs)


def validate_smoothed_forward_progress_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("validate_smoothed_forward_progress_artifact", *args, **kwargs)


def build_smoothed_weekly_dashboard(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("build_smoothed_weekly_dashboard", *args, **kwargs)


def smoothed_weekly_dashboard_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("smoothed_weekly_dashboard_report_payload", *args, **kwargs)


def validate_smoothed_weekly_dashboard_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("validate_smoothed_weekly_dashboard_artifact", *args, **kwargs)


def update_smoothed_event_monitor(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("update_smoothed_event_monitor", *args, **kwargs)


def smoothed_event_monitor_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("smoothed_event_monitor_report_payload", *args, **kwargs)


def validate_smoothed_event_monitor_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("validate_smoothed_event_monitor_artifact", *args, **kwargs)


def recheck_smoothed_switch_readiness(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("recheck_smoothed_switch_readiness", *args, **kwargs)


def smoothed_switch_readiness_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("smoothed_switch_readiness_report_payload", *args, **kwargs)


def validate_smoothed_switch_readiness_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("validate_smoothed_switch_readiness_artifact", *args, **kwargs)


def build_smoothed_owner_renewal_pack(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("build_smoothed_owner_renewal_pack", *args, **kwargs)


def smoothed_owner_renewal_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("smoothed_owner_renewal_report_payload", *args, **kwargs)


def validate_smoothed_owner_renewal_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_operations("validate_smoothed_owner_renewal_artifact", *args, **kwargs)


def _call_smoothed_bootstrap(name: str, *args: Any, **kwargs: Any) -> Any:
    from ai_trading_system.etf_portfolio import (
        dynamic_v3_system_target_smoothed_bootstrap as canonical,
    )

    return getattr(canonical, name)(*args, **kwargs)


def run_smoothed_daily_emission(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("run_smoothed_daily_emission", *args, **kwargs)


def smoothed_daily_emission_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("smoothed_daily_emission_report_payload", *args, **kwargs)


def validate_smoothed_daily_emission_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("validate_smoothed_daily_emission_artifact", *args, **kwargs)


def scan_smoothed_outcome_due(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("scan_smoothed_outcome_due", *args, **kwargs)


def smoothed_outcome_due_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("smoothed_outcome_due_report_payload", *args, **kwargs)


def validate_smoothed_outcome_due_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("validate_smoothed_outcome_due_artifact", *args, **kwargs)


def run_smoothed_outcome_update(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("run_smoothed_outcome_update", *args, **kwargs)


def smoothed_outcome_update_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("smoothed_outcome_update_report_payload", *args, **kwargs)


def validate_smoothed_outcome_update_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("validate_smoothed_outcome_update_artifact", *args, **kwargs)


def run_smoothed_forward_classification(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("run_smoothed_forward_classification", *args, **kwargs)


def smoothed_forward_classification_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap(
        "smoothed_forward_classification_report_payload", *args, **kwargs
    )


def validate_smoothed_forward_classification_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap(
        "validate_smoothed_forward_classification_artifact", *args, **kwargs
    )


def run_smoothed_forward_weekly_run(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("run_smoothed_forward_weekly_run", *args, **kwargs)


def smoothed_forward_weekly_run_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap("smoothed_forward_weekly_run_report_payload", *args, **kwargs)


def validate_smoothed_forward_weekly_run_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_bootstrap(
        "validate_smoothed_forward_weekly_run_artifact", *args, **kwargs
    )


def _call_smoothed_freshness(name: str, *args: Any, **kwargs: Any) -> Any:
    from ai_trading_system.etf_portfolio import (
        dynamic_v3_system_target_smoothed_freshness as canonical,
    )

    return getattr(canonical, name)(*args, **kwargs)


def run_smoothed_data_preflight(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("run_smoothed_data_preflight", *args, **kwargs)


def smoothed_data_preflight_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("smoothed_data_preflight_report_payload", *args, **kwargs)


def validate_smoothed_data_preflight_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("validate_smoothed_data_preflight_artifact", *args, **kwargs)


def run_smoothed_latest_emission(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("run_smoothed_latest_emission", *args, **kwargs)


def smoothed_latest_emission_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("smoothed_latest_emission_report_payload", *args, **kwargs)


def validate_smoothed_latest_emission_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("validate_smoothed_latest_emission_artifact", *args, **kwargs)


def run_smoothed_blocked_explain(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("run_smoothed_blocked_explain", *args, **kwargs)


def smoothed_blocked_explain_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("smoothed_blocked_explain_report_payload", *args, **kwargs)


def validate_smoothed_blocked_explain_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("validate_smoothed_blocked_explain_artifact", *args, **kwargs)


def run_smoothed_refresh_plan(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("run_smoothed_refresh_plan", *args, **kwargs)


def smoothed_refresh_plan_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("smoothed_refresh_plan_report_payload", *args, **kwargs)


def validate_smoothed_refresh_plan_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("validate_smoothed_refresh_plan_artifact", *args, **kwargs)


def run_smoothed_bootstrap_retry(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("run_smoothed_bootstrap_retry", *args, **kwargs)


def smoothed_bootstrap_retry_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("smoothed_bootstrap_retry_report_payload", *args, **kwargs)


def validate_smoothed_bootstrap_retry_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_freshness("validate_smoothed_bootstrap_retry_artifact", *args, **kwargs)


def _call_smoothed_refresh(name: str, *args: Any, **kwargs: Any) -> Any:
    from ai_trading_system.etf_portfolio import (
        dynamic_v3_system_target_smoothed_refresh as smoothed_refresh,
    )

    return getattr(smoothed_refresh, name)(*args, **kwargs)


def run_smoothed_source_refresh(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("run_smoothed_source_refresh", *args, **kwargs)


def smoothed_source_refresh_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("smoothed_source_refresh_report_payload", *args, **kwargs)


def validate_smoothed_source_refresh_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("validate_smoothed_source_refresh_artifact", *args, **kwargs)


def run_smoothed_post_refresh_validation(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("run_smoothed_post_refresh_validation", *args, **kwargs)


def smoothed_post_refresh_validation_report_payload(
    *args: Any, **kwargs: Any
) -> dict[str, Any]:
    return _call_smoothed_refresh(
        "smoothed_post_refresh_validation_report_payload", *args, **kwargs
    )


def validate_smoothed_post_refresh_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("validate_smoothed_post_refresh_artifact", *args, **kwargs)


def run_smoothed_retry_resume(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("run_smoothed_retry_resume", *args, **kwargs)


def smoothed_retry_resume_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("smoothed_retry_resume_report_payload", *args, **kwargs)


def validate_smoothed_retry_resume_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("validate_smoothed_retry_resume_artifact", *args, **kwargs)


def build_smoothed_sample_growth(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("build_smoothed_sample_growth", *args, **kwargs)


def smoothed_sample_growth_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("smoothed_sample_growth_report_payload", *args, **kwargs)


def validate_smoothed_sample_growth_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("validate_smoothed_sample_growth_artifact", *args, **kwargs)


def pack_smoothed_data_readiness(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("pack_smoothed_data_readiness", *args, **kwargs)


def smoothed_data_readiness_report_payload(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("smoothed_data_readiness_report_payload", *args, **kwargs)


def validate_smoothed_data_readiness_artifact(*args: Any, **kwargs: Any) -> dict[str, Any]:
    return _call_smoothed_refresh("validate_smoothed_data_readiness_artifact", *args, **kwargs)
