...
def write_pipeline_health_summary(
    *,
    ...
    write_text_atomic(output_md_path, render_pipeline_health_summary_markdown(payload))
    ...
    write_text_atomic(run_log_md_path, render_pipeline_health_summary_run_log(run_log))
