...
from ai_trading_system.cli_commands.research_execution_common import (
    as_of_kwargs as _as_of_kwargs,
)
from ai_trading_system.cli_commands.research_execution_common import (
    date_range_kwargs as _date_range_kwargs,
)
from ai_trading_system.cli_commands.research_execution_common import (
...
from ai_trading_system.cli_commands.research_execution_growth_tilt import (
    register_growth_tilt_execution_strategy_commands,
)
...
def register_execution_semantics_strategy_commands(strategies_app: typer.Typer) -> None:
    ...
    register_growth_tilt_execution_strategy_commands(strategies_app)
