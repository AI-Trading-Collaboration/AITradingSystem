...
from ai_trading_system.cli_commands.research_execution_growth_tilt_pit_replay import (
    register_growth_tilt_pit_replay_strategy_commands,
)
...
def register_growth_tilt_execution_strategy_commands(strategies_app: typer.Typer) -> None:
    ...
    register_growth_tilt_pit_replay_strategy_commands(strategies_app)
