...
from ai_trading_system.etf_portfolio import (
    dynamic_v3_signal_input_completeness_recovery as signal_input_completeness_recovery,
)
from ai_trading_system.etf_portfolio import (
...
def dynamic_v3_selection_attribution_run_command(
    ...
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="selection attribution artifact root。"),
...
def dynamic_v3_selection_attribution_report_command(
    latest: Annotated[
        bool,
        typer.Option("--latest/--no-latest", help="读取 latest selection attribution。"),
    ] = False,
    attribution_id: Annotated[
        str | None,
        typer.Option("--attribution-id", help="selection attribution id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="selection attribution artifact root。"),
    ...
    recommendation = _mapping_obj(payload.get("recommendation_reason_breakdown"))
...
def dynamic_v3_limited_long_risk_run_command(
    ...
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="limited long risk artifact root。"),
    ...
    metrics = _mapping_obj(long_window.get("metrics"))
...
def dynamic_v3_limited_long_risk_report_command(
    latest: Annotated[
        bool,
        typer.Option("--latest/--no-latest", help="读取 latest limited long risk。"),
    ] = False,
    risk_review_id: Annotated[
        str | None,
        typer.Option("--risk-review-id", help="risk review id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="limited long risk artifact root。"),
    ...
    long_window = _mapping_obj(payload.get("long_window_risk_return"))
    metrics = _mapping_obj(long_window.get("metrics"))
...
def dynamic_v3_limited_consistency_run_command(
    ...
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="limited consistency artifact root。"),
...
def dynamic_v3_limited_consistency_report_command(
    latest: Annotated[
        bool,
        typer.Option("--latest/--no-latest", help="读取 latest limited consistency。"),
    ] = False,
    consistency_id: Annotated[
        str | None,
        typer.Option("--consistency-id", help="consistency id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="limited consistency artifact root。"),
    ...
    rolling = _mapping_obj(payload.get("rolling_consistency_summary"))
    regime = _mapping_obj(payload.get("regime_consistency_summary"))
    stability = _mapping_obj(payload.get("stability_consistency_summary"))
...
def dynamic_v3_data_warning_impact_run_command(
    ...
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="data warning impact artifact root。"),
...
def dynamic_v3_data_warning_impact_report_command(
    latest: Annotated[
        bool,
        typer.Option("--latest/--no-latest", help="读取 latest data warning impact。"),
    ] = False,
    impact_id: Annotated[
        str | None,
        typer.Option("--impact-id", help="data warning impact id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="data warning impact artifact root。"),
    ...
    inventory = _mapping_obj(payload.get("data_warning_inventory"))
    sensitivity = _mapping_obj(payload.get("recommendation_sensitivity_to_warnings"))
    warning_ids = [
        str(row.get("warning_id"))
        for row in _records_obj(inventory.get("warnings"))
        if row.get("warning_id")
    ]
...
def dynamic_v3_research_method_hardening_run_command(
    selection_attribution_id: Annotated[
        str,
        typer.Option("--selection-attribution-id", help="selection attribution id。"),
    ],
    risk_review_id: Annotated[
        str,
        typer.Option("--risk-review-id", help="risk review id。"),
    ...
    data_warning_impact_id: Annotated[
        str,
        typer.Option("--data-warning-impact-id", help="data warning impact id。"),
    ],
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="research method hardening artifact root。"),
...
def dynamic_v3_research_method_hardening_report_command(
    latest: Annotated[
        bool,
        typer.Option("--latest/--no-latest", help="读取 latest hardening pack。"),
    ] = False,
    hardening_id: Annotated[
        str | None,
        typer.Option("--hardening-id", help="hardening id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="research method hardening artifact root。"),
    ...
    decision = _mapping_obj(payload.get("hardening_decision_payload"))
...
def dynamic_v3_risk_capped_limited_config_validate_command(
    ...
    payload = system_target.validate_risk_capped_limited_config(config_path)
    typer.echo(f"status={payload['status']}")
    typer.echo(f"failed_check_count={payload['failed_check_count']}")
    typer.echo("research_target_only=true")
    typer.echo("not_official_target_weights=true")
...
def dynamic_v3_risk_capped_limited_report_config_command(
    ...
    ] = system_target.DEFAULT_RISK_CAPPED_CONFIG_DIR,
) -> None:
...
def dynamic_v3_risk_capped_limited_generate_command(
    ...
    ] = system_target.DEFAULT_RISK_CAPPED_LIMITED_DIR,
) -> None:
...
def dynamic_v3_risk_capped_limited_report_command(
    ...
    payload = system_target.risk_capped_limited_report_payload(
...
def dynamic_v3_validate_risk_capped_limited_command(
    ...
    payload = system_target.validate_risk_capped_limited_artifact(
        risk_capped_id=risk_capped_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_risk_capped_backfill_run_command(
    ...
    ] = system_target.DEFAULT_RISK_CAPPED_BACKFILL_DIR,
) -> None:
    """运行 TRADING-231 risk-capped paper shadow backfill。"""
    result = system_target.run_risk_capped_backfill(config_path=config_path, output_dir=output_dir)
...
def dynamic_v3_risk_capped_backfill_report_command(
    ...
    payload = system_target.risk_capped_backfill_report_payload(
        backfill_id=backfill_id,
        latest=latest,
        output_dir=output_dir,
    )
...
def dynamic_v3_validate_risk_capped_backfill_command(
    ...
    payload = system_target.validate_risk_capped_backfill_artifact(
        backfill_id=backfill_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_risk_capped_comparison_run_command(
    ...
    ] = system_target.DEFAULT_RISK_CAPPED_COMPARISON_DIR,
) -> None:
...
def dynamic_v3_risk_capped_comparison_report_command(
    ...
    payload = system_target.risk_capped_comparison_report_payload(
...
def dynamic_v3_validate_risk_capped_comparison_command(
    ...
    payload = system_target.validate_risk_capped_comparison_artifact(
        comparison_id=comparison_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_risk_capped_review_pack_command(
    ...
    ] = system_target.DEFAULT_RISK_CAPPED_REVIEW_DIR,
) -> None:
    """生成 TRADING-233 risk-capped research method review pack。"""
    result = system_target.build_risk_capped_review_pack(
        comparison_id=comparison_id,
        risk_capped_backfill_id=risk_capped_backfill_id,
        output_dir=output_dir,
    )
...
def dynamic_v3_risk_capped_review_report_command(
    ...
    payload = system_target.risk_capped_review_report_payload(
        review_id=review_id,
        latest=latest,
        output_dir=output_dir,
    )
...
def dynamic_v3_validate_risk_capped_review_command(
    ...
    payload = system_target.validate_risk_capped_review_artifact(
        review_id=review_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_smoothed_review_attribution_run_command(
    ...
    ] = system_target.DEFAULT_SMOOTHED_REVIEW_ATTRIBUTION_DIR,
) -> None:
...
def dynamic_v3_smoothed_review_attribution_report_command(
    ...
    payload = system_target.smoothed_review_attribution_report_payload(
        attribution_id=attribution_id,
        latest=latest,
        output_dir=output_dir,
    )
    breakdown = _mapping_obj(payload.get("smoothed_decision_reason_breakdown"))
    typer.echo(f"attribution_id={payload['attribution_id']}")
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_validate_smoothed_review_attribution_command(
    ...
    payload = system_target.validate_smoothed_review_attribution_artifact(
        attribution_id=attribution_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_smoothing_benefit_lag_run_command(
    ...
    ] = system_target.DEFAULT_SMOOTHING_BENEFIT_LAG_DIR,
) -> None:
    ...
    tradeoff = _find_method_obj(
        result["benefit_lag_tradeoff_matrix"].get("methods"),
    ...
    typer.echo(f"benefit_status={tradeoff.get('benefit_status')}")
    typer.echo(f"lag_cost_status={tradeoff.get('lag_cost_status')}")
    typer.echo(f"tradeoff_status={tradeoff.get('tradeoff_status')}")
    typer.echo("broker_action_allowed=false")
...
def dynamic_v3_smoothing_benefit_lag_report_command(
    ...
    payload = system_target.smoothing_benefit_lag_report_payload(
        drilldown_id=drilldown_id,
        latest=latest,
        output_dir=output_dir,
    )
    tradeoff = _find_method_obj(
        _mapping_obj(payload.get("benefit_lag_tradeoff_matrix")).get("methods"),
        "smooth_weights_3d_limited_adjustment",
    )
...
def dynamic_v3_validate_smoothing_benefit_lag_command(
    ...
    payload = system_target.validate_smoothing_benefit_lag_artifact(
        drilldown_id=drilldown_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_smoothed_regime_validation_run_command(
    ...
    ] = system_target.DEFAULT_SMOOTHED_REGIME_VALIDATION_DIR,
) -> None:
    ...
    sideways = _find_method_obj(
        result["sideways_validation_summary"].get("methods"),
        "smooth_weights_3d_limited_adjustment",
    )
    recovery = _find_method_obj(
        result["recovery_lag_validation_summary"].get("methods"),
        "smooth_weights_3d_limited_adjustment",
    )
    ...
    typer.echo(f"sideways_status={sideways.get('sideways_status')}")
    typer.echo(f"recovery_lag_status={recovery.get('lag_status')}")
    typer.echo("broker_action_allowed=false")
...
def dynamic_v3_smoothed_regime_validation_report_command(
    ...
    payload = system_target.smoothed_regime_validation_report_payload(
        regime_validation_id=regime_validation_id,
        latest=latest,
        output_dir=output_dir,
    )
    sideways = _find_method_obj(
        _mapping_obj(payload.get("sideways_validation_summary")).get("methods"),
        "smooth_weights_3d_limited_adjustment",
    )
    recovery = _find_method_obj(
        _mapping_obj(payload.get("recovery_lag_validation_summary")).get("methods"),
        "smooth_weights_3d_limited_adjustment",
    )
...
def dynamic_v3_validate_smoothed_regime_validation_command(
    ...
    payload = system_target.validate_smoothed_regime_validation_artifact(
        regime_validation_id=regime_validation_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_smoothed_confirmation_register_command(
    ...
    ] = system_target.DEFAULT_SMOOTHED_FORWARD_CONFIRMATION_DIR,
) -> None:
    ...
    targets = result["smoothed_confirmation_targets"]["targets"]
    typer.echo(f"confirmation_id={result['confirmation_id']}")
    typer.echo(f"confirmation_dir={result['confirmation_dir']}")
    typer.echo("registered_targets=" + ",".join(row["target_id"] for row in targets))
    typer.echo("auto_apply=false")
    typer.echo("broker_action_allowed=false")
...
def dynamic_v3_smoothed_confirmation_report_command(
    ...
    payload = system_target.smoothed_confirmation_report_payload(
        confirmation_id=confirmation_id,
        latest=latest,
        output_dir=output_dir,
    )
    targets = _records_obj(
        _mapping_obj(payload.get("smoothed_confirmation_targets")).get("targets")
    )
    typer.echo(f"confirmation_id={payload['confirmation_id']}")
    typer.echo(f"status={payload['status']}")
    typer.echo("registered_targets=" + ",".join(str(row.get("target_id")) for row in targets))
...
def dynamic_v3_validate_smoothed_confirmation_command(
    ...
    payload = system_target.validate_smoothed_confirmation_artifact(
        confirmation_id=confirmation_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_smoothed_watch_pack_run_command(
    ...
    ] = system_target.DEFAULT_SMOOTHED_WATCH_PACK_DIR,
) -> None:
...
def dynamic_v3_smoothed_watch_pack_report_command(
    ...
    payload = system_target.smoothed_watch_pack_report_payload(
        watch_pack_id=watch_pack_id,
        latest=latest,
        output_dir=output_dir,
    )
    summary = _mapping_obj(payload.get("smoothed_watch_summary"))
...
def dynamic_v3_validate_smoothed_watch_pack_command(
    ...
    payload = system_target.validate_smoothed_watch_pack_artifact(
        watch_pack_id=watch_pack_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_smoothed_churn_backfill_report_command(
    ...
    primary = _find_method_obj(
        _records_obj(summary.get("methods")),
        "smooth_weights_3d_limited_adjustment",
    )
    typer.echo(f"churn_id={payload['churn_id']}")
    typer.echo(f"status={payload['status']}")
    typer.echo(f"best_churn_reduction_method={summary.get('best_churn_reduction_method')}")
    typer.echo(f"smooth_3d_churn_reduction_status={primary.get('churn_reduction_status')}")
...
def dynamic_v3_sideways_mixed_attribution_run_command(
    ...
    typer.echo(f"dominant_reason={reason['dominant_reason']}")
...
def dynamic_v3_sideways_mixed_attribution_report_command(
    ...
    typer.echo(f"status={payload['status']}")
    typer.echo(f"dominant_reason={reason.get('dominant_reason')}")
...
def dynamic_v3_smoothed_switch_readiness_recheck_command(
    ...
    typer.echo("owner_decision_required=true")
    typer.echo("broker_action_allowed=false")
    typer.echo("production_effect=none")
...
def dynamic_v3_smoothed_daily_emission_run_command(
    ...
    manifest = result["manifest"]
    event = result["smoothed_forward_events"][0]
    ...
    typer.echo(f"event_status={event['event_status']}")
...
def dynamic_v3_filtered_candidate_evidence_run_command(
    ...
    ] = filtered_readiness.DEFAULT_FILTERED_CANDIDATE_EVIDENCE_DIR,
) -> None:
    ...
    result = filtered_readiness.run_filtered_candidate_evidence(
        candidate=candidate,
...
def dynamic_v3_filtered_candidate_evidence_report_command(
    ...
    evidence_id: Annotated[
        str | None,
        typer.Option("--evidence-id", help="filtered candidate evidence id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="filtered candidate evidence root。"),
    ...
    payload = filtered_readiness.filtered_candidate_evidence_report_payload(
...
def dynamic_v3_validate_filtered_candidate_evidence_command(
    ...
    _echo_validation_payload(
        filtered_readiness.validate_filtered_candidate_evidence_artifact(
            evidence_id=evidence_id,
            output_dir=output_dir,
        )
    )
...
def dynamic_v3_median_regime_filter_spec_review_command(
    ...
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="median regime filter spec root。"),
    ] = filtered_readiness.DEFAULT_MEDIAN_REGIME_FILTER_SPEC_DIR,
) -> None:
    result = filtered_readiness.review_median_regime_filter_spec(
        candidate=candidate,
        output_dir=output_dir,
    )
...
def dynamic_v3_median_regime_filter_spec_report_command(
    ...
    payload = filtered_readiness.median_regime_filter_spec_report_payload(
        spec_id=spec_id,
        latest=latest,
        output_dir=output_dir,
    )
...
def dynamic_v3_validate_median_regime_filter_spec_command(
    ...
    _echo_validation_payload(
        filtered_readiness.validate_median_regime_filter_spec_artifact(
            spec_id=spec_id,
            output_dir=output_dir,
        )
    )
...
def dynamic_v3_filtered_candidate_stress_backfill_run_command(
    ...
    spec_dir: Annotated[
        Path,
        typer.Option("--spec-dir", help="median regime filter spec root。"),
    ] = filtered_readiness.DEFAULT_MEDIAN_REGIME_FILTER_SPEC_DIR,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="stress backfill root。"),
    ] = filtered_readiness.DEFAULT_FILTERED_CANDIDATE_STRESS_BACKFILL_DIR,
) -> None:
    if not spec_id:
        raise typer.BadParameter("spec-id is required")
    result = filtered_readiness.run_filtered_candidate_stress_backfill(
        candidate=candidate,
        spec_id=spec_id,
        spec_dir=spec_dir,
        output_dir=output_dir,
...
def dynamic_v3_filtered_candidate_stress_backfill_report_command(
    ...
    stress_backfill_id: Annotated[
        str | None,
        typer.Option("--stress-backfill-id", help="stress backfill id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="stress backfill root。"),
    ...
    payload = filtered_readiness.filtered_candidate_stress_backfill_report_payload(
...
def dynamic_v3_validate_filtered_candidate_stress_backfill_command(
    ...
    _echo_validation_payload(
        filtered_readiness.validate_filtered_candidate_stress_backfill_artifact(
            stress_backfill_id=stress_backfill_id,
            output_dir=output_dir,
        )
    )
...
def dynamic_v3_drawdown_mismatch_reduction_run_command(
    ...
    stress_backfill_dir: Annotated[
        Path,
        typer.Option("--stress-backfill-dir", help="stress backfill root。"),
    ] = filtered_readiness.DEFAULT_FILTERED_CANDIDATE_STRESS_BACKFILL_DIR,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="drawdown mismatch reduction root。"),
    ] = filtered_readiness.DEFAULT_DRAWDOWN_MISMATCH_REDUCTION_DIR,
) -> None:
    result = filtered_readiness.run_drawdown_mismatch_reduction(
        stress_backfill_id=stress_backfill_id,
...
def dynamic_v3_drawdown_mismatch_reduction_report_command(
    ...
    reduction_id: Annotated[
        str | None,
        typer.Option("--reduction-id", help="reduction id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="drawdown mismatch reduction root。"),
    ...
    payload = filtered_readiness.drawdown_mismatch_reduction_report_payload(
...
def dynamic_v3_validate_drawdown_mismatch_reduction_command(
    ...
    _echo_validation_payload(
        filtered_readiness.validate_drawdown_mismatch_reduction_artifact(
            reduction_id=reduction_id,
            output_dir=output_dir,
        )
    )
...
def dynamic_v3_flip_rotation_reduction_run_command(
    ...
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="flip rotation reduction root。"),
    ] = filtered_readiness.DEFAULT_FLIP_ROTATION_REDUCTION_DIR,
) -> None:
    result = filtered_readiness.run_flip_rotation_reduction(
        stress_backfill_id=stress_backfill_id,
        stress_backfill_dir=stress_backfill_dir,
        output_dir=output_dir,
    )
...
def dynamic_v3_flip_rotation_reduction_report_command(
    ...
    flip_reduction_id: Annotated[
        str | None,
        typer.Option("--flip-reduction-id", help="flip reduction id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="flip rotation reduction root。"),
    ...
    payload = filtered_readiness.flip_rotation_reduction_report_payload(
...
def dynamic_v3_validate_flip_rotation_reduction_command(
    ...
    _echo_validation_payload(
        filtered_readiness.validate_flip_rotation_reduction_artifact(
            flip_reduction_id=flip_reduction_id,
            output_dir=output_dir,
        )
    )
...
def dynamic_v3_filtered_candidate_ab_review_run_command(
    ...
    mismatch_reduction_id: Annotated[
        str,
        typer.Option("--mismatch-reduction-id", help="drawdown mismatch reduction id。"),
    ],
    flip_reduction_id: Annotated[
        str,
        typer.Option("--flip-reduction-id", help="flip reduction id。"),
    ...
    mismatch_reduction_dir: Annotated[
        Path,
        typer.Option("--mismatch-reduction-dir", help="drawdown mismatch reduction root。"),
    ] = filtered_readiness.DEFAULT_DRAWDOWN_MISMATCH_REDUCTION_DIR,
    flip_reduction_dir: Annotated[
        Path,
        typer.Option("--flip-reduction-dir", help="flip rotation reduction root。"),
    ] = filtered_readiness.DEFAULT_FLIP_ROTATION_REDUCTION_DIR,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="filtered candidate A/B root。"),
    ] = filtered_readiness.DEFAULT_FILTERED_CANDIDATE_AB_REVIEW_DIR,
) -> None:
    result = filtered_readiness.run_filtered_candidate_ab_review(
        stress_backfill_id=stress_backfill_id,
...
def dynamic_v3_filtered_candidate_ab_review_report_command(
    ...
    ab_review_id: Annotated[
        str | None,
        typer.Option("--ab-review-id", help="A/B review id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="filtered candidate A/B root。"),
    ...
    payload = filtered_readiness.filtered_candidate_ab_review_report_payload(
...
def dynamic_v3_validate_filtered_candidate_ab_review_command(
    ...
    _echo_validation_payload(
        filtered_readiness.validate_filtered_candidate_ab_review_artifact(
            ab_review_id=ab_review_id,
            output_dir=output_dir,
        )
    )
...
def dynamic_v3_signal_gate_confirmation_register_command(
    ...
    ab_review_dir: Annotated[
        Path,
        typer.Option("--ab-review-dir", help="filtered candidate A/B root。"),
    ] = filtered_readiness.DEFAULT_FILTERED_CANDIDATE_AB_REVIEW_DIR,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="signal gate confirmation root。"),
    ] = filtered_readiness.DEFAULT_SIGNAL_GATE_CONFIRMATION_DIR,
) -> None:
    result = filtered_readiness.register_signal_gate_confirmation(
        ab_review_id=ab_review_id,
...
def dynamic_v3_signal_gate_confirmation_report_command(
    ...
    payload = filtered_readiness.signal_gate_confirmation_report_payload(
        confirmation_id=confirmation_id,
        latest=latest,
        output_dir=output_dir,
    )
...
def dynamic_v3_validate_signal_gate_confirmation_command(
    ...
    _echo_validation_payload(
        filtered_readiness.validate_signal_gate_confirmation_artifact(
            confirmation_id=confirmation_id,
            output_dir=output_dir,
        )
    )
...
def dynamic_v3_filtered_formalization_readiness_run_command(
    ...
    confirmation_dir: Annotated[
        Path,
        typer.Option("--confirmation-dir", help="signal gate confirmation root。"),
    ] = filtered_readiness.DEFAULT_SIGNAL_GATE_CONFIRMATION_DIR,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="filtered formalization readiness root。"),
    ] = filtered_readiness.DEFAULT_FILTERED_FORMALIZATION_READINESS_DIR,
) -> None:
    result = filtered_readiness.run_filtered_formalization_readiness(
        ab_review_id=ab_review_id,
        confirmation_id=confirmation_id,
        ab_review_dir=ab_review_dir,
...
def dynamic_v3_filtered_formalization_readiness_report_command(
    ...
    payload = filtered_readiness.filtered_formalization_readiness_report_payload(
        readiness_id=readiness_id,
        latest=latest,
        output_dir=output_dir,
    )
...
def dynamic_v3_validate_filtered_formalization_readiness_command(
    ...
    _echo_validation_payload(
        filtered_readiness.validate_filtered_formalization_readiness_artifact(
            readiness_id=readiness_id,
            output_dir=output_dir,
        )
    )
...
def dynamic_v3_owner_filtered_candidate_review_pack_command(
    ...
    readiness_dir: Annotated[
        Path,
        typer.Option("--readiness-dir", help="filtered formalization readiness root。"),
    ] = filtered_readiness.DEFAULT_FILTERED_FORMALIZATION_READINESS_DIR,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="owner filtered candidate review root。"),
    ] = filtered_readiness.DEFAULT_OWNER_FILTERED_CANDIDATE_REVIEW_DIR,
) -> None:
    result = filtered_readiness.build_owner_filtered_candidate_review(
        readiness_id=readiness_id,
...
def dynamic_v3_owner_filtered_candidate_review_report_command(
    ...
    owner_review_id: Annotated[
        str | None,
        typer.Option("--owner-review-id", help="owner review id。"),
    ] = None,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="owner filtered candidate review root。"),
    ...
    payload = filtered_readiness.owner_filtered_candidate_review_report_payload(
...
def dynamic_v3_validate_owner_filtered_candidate_review_command(
    ...
    _echo_validation_payload(
        filtered_readiness.validate_owner_filtered_candidate_review_artifact(
            owner_review_id=owner_review_id,
            output_dir=output_dir,
        )
    )
...
def dynamic_v3_filtered_next_decision_run_command(
    ...
    owner_review_dir: Annotated[
        Path,
        typer.Option("--owner-review-dir", help="owner filtered candidate review root。"),
    ] = filtered_readiness.DEFAULT_OWNER_FILTERED_CANDIDATE_REVIEW_DIR,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="filtered next decision root。"),
    ] = filtered_readiness.DEFAULT_FILTERED_NEXT_DECISION_DIR,
) -> None:
    result = filtered_readiness.run_filtered_next_decision(
        owner_review_id=owner_review_id,
...
def dynamic_v3_filtered_next_decision_report_command(
    ...
    payload = filtered_readiness.filtered_next_decision_report_payload(
        decision_id=decision_id,
        latest=latest,
        output_dir=output_dir,
    )
...
def dynamic_v3_signal_input_completeness_recovery_run_command(
    ...
    ] = signal_input_completeness_recovery.DEFAULT_SIGNAL_INPUT_COMPLETENESS_RECOVERY_DIR,
) -> None:
    result = signal_input_completeness_recovery.run_signal_input_completeness_recovery(
        as_of=None if as_of is None else _parse_dynamic_v3_outcome_date(as_of, "--as-of"),
        monitor_id=monitor_id,
    ...
    report = _mapping_obj(result.get("signal_input_completeness_recovery_report"))
    validation = _mapping_obj(result.get("signal_input_completeness_recovery_validation"))
    ...
    typer.echo(f"blocking_count={report.get('blocking_count')}")
    typer.echo(f"warning_count={report.get('warning_count')}")
    typer.echo(f"blocker_list={','.join(_texts(report.get('blocker_list')))}")
    typer.echo(f"warning_list={','.join(_texts(report.get('warning_list')))}")
    typer.echo(f"hard_stop_triggered={report.get('hard_stop_triggered')}")
    typer.echo(f"next_required_action={report.get('next_required_action')}")
    typer.echo(f"validation_status={validation.get('status')}")
    typer.echo("signal_input_completeness_recovery_only=true")
    typer.echo("signal_artifacts_fabricated=false")
    typer.echo("broker_action_allowed=false")
    typer.echo("production_effect=none")
...
def dynamic_v3_signal_input_completeness_recovery_report_command(
    ...
    payload = signal_input_completeness_recovery.signal_input_completeness_recovery_report_payload(
        recovery_id=recovery_id,
        latest=latest,
        output_dir=output_dir,
    )
    report = _mapping_obj(payload.get("signal_input_completeness_recovery_report"))
    validation = _mapping_obj(payload.get("signal_input_completeness_recovery_validation"))
...
def dynamic_v3_validate_signal_input_completeness_recovery_command(
    ...
    if not resolved_id:
        raise typer.BadParameter("--recovery-id or --latest is required")
    _echo_validation_payload(
        signal_input_completeness_recovery.validate_signal_input_completeness_recovery_artifact(
...
def dynamic_v3_hypothesis_backlog_build_command(
    ...
    ] = system_target.DEFAULT_WEIGHT_OPTIMIZATION_HYPOTHESIS_CONFIG_PATH,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="hypothesis backlog artifact root。"),
    ] = system_target.DEFAULT_HYPOTHESIS_BACKLOG_DIR,
) -> None:
...
def dynamic_v3_hypothesis_backlog_report_command(
    ...
    payload = system_target.hypothesis_backlog_report_payload(
...
def dynamic_v3_validate_hypothesis_backlog_command(
    ...
    payload = system_target.validate_hypothesis_backlog_artifact(
        backlog_id=backlog_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_variant_transform_validate_spec_command(
    ...
    ] = system_target.DEFAULT_WEIGHT_VARIANT_TRANSFORM_CONFIG_PATH,
) -> None:
    """校验 TRADING-240 lightweight variant transform config。"""
    payload = system_target.validate_weight_variant_transform_spec_config(config_path)
    typer.echo(f"status={payload['status']}")
    typer.echo(f"failed_check_count={payload['failed_check_count']}")
    typer.echo("experiment_only=true")
    typer.echo("broker_action_allowed=false")
...
def dynamic_v3_variant_transform_report_spec_command(
    ...
    ] = system_target.DEFAULT_VARIANT_TRANSFORM_SPEC_DIR,
) -> None:
...
def dynamic_v3_validate_variant_transform_spec_command(
    ...
    payload = system_target.validate_variant_transform_spec_artifact(
        spec_id=spec_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_experiment_matrix_build_command(
    ...
    ] = system_target.DEFAULT_WEIGHT_EXPERIMENT_MATRIX_CONFIG_PATH,
    output_dir: Annotated[
        Path,
        typer.Option("--output-dir", help="experiment matrix artifact root。"),
    ] = system_target.DEFAULT_EXPERIMENT_MATRIX_DIR,
) -> None:
...
def dynamic_v3_experiment_matrix_report_command(
    ...
    payload = system_target.experiment_matrix_report_payload(
        matrix_id=matrix_id,
        latest=latest,
        output_dir=output_dir,
    )
...
def dynamic_v3_validate_experiment_matrix_command(
    ...
    payload = system_target.validate_experiment_matrix_artifact(
        matrix_id=matrix_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_batch_experiment_run_command(
    ...
    ] = system_target.DEFAULT_BATCH_EXPERIMENT_DIR,
    price_cache_path: Annotated[
        Path | None,
    ...
    result = system_target.run_batch_experiment(
        matrix_id=matrix_id,
        matrix_dir=matrix_dir,
        baseline_backfill_dir=baseline_backfill_dir,
        output_dir=output_dir,
...
def dynamic_v3_batch_experiment_report_command(
    ...
    payload = system_target.batch_experiment_report_payload(
        batch_id=batch_id,
        latest=latest,
        output_dir=output_dir,
    )
...
def dynamic_v3_validate_batch_experiment_command(
    ...
    payload = system_target.validate_batch_experiment_artifact(
        batch_id=batch_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_experiment_triage_run_command(
    ...
    ] = system_target.DEFAULT_EXPERIMENT_TRIAGE_DIR,
) -> None:
    """运行 TRADING-243 experiment triage gate。"""
    result = system_target.run_experiment_triage(
        batch_id=batch_id,
        batch_dir=batch_dir,
        matrix_dir=matrix_dir,
        output_dir=output_dir,
...
def dynamic_v3_experiment_triage_report_command(
    ...
    payload = system_target.experiment_triage_report_payload(
        triage_id=triage_id,
        latest=latest,
        output_dir=output_dir,
    )
...
def dynamic_v3_validate_experiment_triage_command(
    ...
    payload = system_target.validate_experiment_triage_artifact(
        triage_id=triage_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_top_variant_interpretation_run_command(
    ...
    ] = system_target.DEFAULT_TOP_VARIANT_INTERPRETATION_DIR,
) -> None:
    """生成 TRADING-244 top variant interpretation pack。"""
    result = system_target.run_top_variant_interpretation(
        triage_id=triage_id,
...
def dynamic_v3_top_variant_interpretation_report_command(
    ...
    payload = system_target.top_variant_interpretation_report_payload(
        interpretation_id=interpretation_id,
        latest=latest,
        output_dir=output_dir,
    )
...
def dynamic_v3_validate_top_variant_interpretation_command(
    ...
    payload = system_target.validate_top_variant_interpretation_artifact(
        interpretation_id=interpretation_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_method_promotion_plan_run_command(
    ...
    ] = system_target.DEFAULT_METHOD_PROMOTION_PLAN_DIR,
) -> None:
    """生成 TRADING-245 formal research method promotion plan。"""
    result = system_target.run_method_promotion_plan(
        triage_id=triage_id,
        interpretation_id=interpretation_id,
        triage_dir=triage_dir,
        interpretation_dir=interpretation_dir,
...
def dynamic_v3_method_promotion_plan_report_command(
    ...
    payload = system_target.method_promotion_plan_report_payload(
...
def dynamic_v3_validate_method_promotion_plan_command(
    ...
    payload = system_target.validate_method_promotion_plan_artifact(
        promotion_plan_id=promotion_plan_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_confirmation_cycle_validate_config_command(
    ...
    payload = validate_confirmation_cycle_schedule_config(config_path=config_path)
    typer.echo(f"status={payload['status']}")
    typer.echo(f"failed_check_count={payload['failed_check_count']}")
    typer.echo("broker_action_allowed=false")
    typer.echo("production_effect=none")
...
def dynamic_v3_validate_confirmation_cycle_weekly_command(
    ...
    payload = validate_confirmation_cycle_weekly_artifact(
        weekly_cycle_id=weekly_cycle_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_pressure_regime_tag_run_command(
    ...
    typer.echo(
        f"defensive_validation_relevant_outcomes={summary['defensive_validation_relevant_outcomes']}"
    )
    typer.echo("broker_action_allowed=false")
    typer.echo("production_effect=none")
...
def dynamic_v3_pressure_regime_tag_validate_config_command(
    ...
    payload = validate_pressure_regime_tagging_config(config_path=config_path)
    typer.echo(f"status={payload['status']}")
    typer.echo(f"failed_check_count={payload['failed_check_count']}")
    typer.echo("broker_action_allowed=false")
    typer.echo("production_effect=none")
...
def dynamic_v3_validate_pressure_regime_tag_command(
    ...
    payload = validate_pressure_regime_tag_artifact(tag_id=tag_id, output_dir=output_dir)
    typer.echo(f"status={payload['status']}")
    typer.echo(f"failed_check_count={payload['failed_check_count']}")
    typer.echo("broker_action_allowed=false")
    typer.echo("production_effect=none")
...
def dynamic_v3_validate_confirmation_dashboard_command(
    ...
    payload = validate_confirmation_dashboard_artifact(
        dashboard_id=dashboard_id,
        output_dir=output_dir,
    )
    typer.echo(f"status={payload['status']}")
...
def dynamic_v3_validate_rule_review_queue_command(
    ...
    payload = validate_rule_review_queue_artifact(queue_id=queue_id, output_dir=output_dir)
    typer.echo(f"status={payload['status']}")
    typer.echo(f"failed_check_count={payload['failed_check_count']}")
    typer.echo("broker_action_allowed=false")
    typer.echo("production_effect=none")
