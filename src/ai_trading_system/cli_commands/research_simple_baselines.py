...
def _make_growth_tilt_output_command(
    ...
    def command(
        ...
        payload = _build_research_payload(lambda: builder(output_root=output_root))
        _print_simple_baseline_payload(label, payload)
...
def strategies_roadmap_update_after_growth_tilt_review_command(
    ...
    _print_simple_baseline_payload("Roadmap update after growth tilt review", payload)
