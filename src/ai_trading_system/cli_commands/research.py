...
@strategies_app.command("simple-baseline-registry-review")
...
@strategies_app.command("qqq-sgov-baseline-backtest")
...
@strategies_app.command("tqqq-sgov-risk-controlled-baseline")
...
@strategies_app.command("trend-vol-allocation-policy-search")
...
@strategies_app.command("simple-baseline-dominance-ranking")
...
@strategies_app.command("simple-baseline-pit-boundary-audit")
...
@strategies_app.command("simple-baseline-cost-sensitivity")
...
@strategies_app.command("simple-baseline-regime-review")
...
@strategies_app.command("simple-baseline-forward-aging-tracker")
...
@strategies_app.command("simple-baseline-paper-shadow-readiness")
...
@strategies_app.command("daily-reader-portfolio-control-safety-summary")
...
@strategies_app.command("simple-baseline-portfolio-dry-run-mapper")
...
@strategies_app.command("simple-baseline-master-review")
...
@strategies_app.command("options-next-stage-gate")
...
@strategies_app.command("equal-risk-qqq-sgov-deep-dive")
...
@strategies_app.command("simple-baseline-period-split-validation")
...
@strategies_app.command("simple-baseline-drawdown-episode-review")
...
@strategies_app.command("dynamic-vs-static-edge-significance-review")
...
@strategies_app.command("tqqq-heavy-pause-rationale-report")
...
@strategies_app.command("simple-baseline-watchlist-owner-decision")
...
def acceleration_reverse_diagnostics_activation_gate_command(
    ...
    ] = DEFAULT_CONTROLLED_RESEARCH_REVIEW_OUTPUT_ROOT / "controlled_research_batch_review.json",
    output_root: Annotated[
        Path,
