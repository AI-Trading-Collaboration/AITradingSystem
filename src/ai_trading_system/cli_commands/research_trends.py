...
from ai_trading_system.dynamic_target_baseline_source_remediation import (
    DEFAULT_DOCS_ROOT as DEFAULT_DYNAMIC_TARGET_SOURCE_REMEDIATION_DOCS_ROOT,
)
from ai_trading_system.dynamic_target_baseline_source_remediation import (
    DEFAULT_DYNAMIC_PREPARATION_ROOT as DEFAULT_DYNAMIC_TARGET_SOURCE_REMEDIATION_PREP_ROOT,
)
from ai_trading_system.dynamic_target_baseline_source_remediation import (
    DEFAULT_OUTPUT_ROOT as DEFAULT_DYNAMIC_TARGET_SOURCE_REMEDIATION_OUTPUT_ROOT,
)
from ai_trading_system.dynamic_target_baseline_source_remediation import (
    MODE as DYNAMIC_TARGET_SOURCE_REMEDIATION_MODE,
)
from ai_trading_system.dynamic_target_baseline_source_remediation import (
...
from ai_trading_system.high_intensity_risk_cap_forward_outcome_review import (
    DEFAULT_DOCS_ROOT as DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_DOCS_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_forward_outcome_review import (
    DEFAULT_EVENT_LOGGER_ROOT as DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_EVENT_LOGGER_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_forward_outcome_review import (
    DEFAULT_FORWARD_OBSERVE_PLAN_ROOT as DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_PLAN_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_forward_outcome_review import (
    DEFAULT_OUTCOME_BINDER_ROOT as DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_BINDER_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_forward_outcome_review import (
    DEFAULT_OUTPUT_ROOT as DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_OUTPUT_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_forward_outcome_review import (
    DEFAULT_PARTIAL_READINESS_ROOT as DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_PARTIAL_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_forward_outcome_review import (
    DEFAULT_THRESHOLD_SELECTION_ROOT as DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_THRESHOLD_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_forward_outcome_review import (
    MODE as HIGH_INTENSITY_FORWARD_OUTCOME_MODE,
)
from ai_trading_system.high_intensity_risk_cap_forward_outcome_review import (
...
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_AUDIT_PACKAGE_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_AUDIT_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_DISABLED_WIRING_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_DISABLED_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_DOCS_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_DOCS_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_EVENT_APPEND_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_EVENT_APPEND_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_GAP_CLOSURE_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_GAP_CLOSURE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_HARDENING_BACKLOG_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_HARDENING_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_IDEMPOTENCY_REPLAY_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_IDEMPOTENCY_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_KILL_SWITCH_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_KILL_SWITCH_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_MANUAL_REVIEW_GATE_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_GATE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_MANUAL_RUN_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_MANUAL_RUN_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_OUTPUT_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_OUTPUT_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_OWNER_DECISION_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_OWNER_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_REPLAY_VALIDATION_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_REPLAY_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    DEFAULT_SMOKE_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_SMOKE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
    MODE as HIGH_INTENSITY_OUTCOME_BINDING_MODE,
)
from ai_trading_system.high_intensity_risk_cap_outcome_binding_contract_plan import (
...
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_DISABLED_WIRING_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_DISABLED_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_DOCS_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_DOCS_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_EVENT_APPEND_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_EVENT_APPEND_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_GAP_CLOSURE_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_GAP_CLOSURE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_HARDENING_BACKLOG_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_HARDENING_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_IDEMPOTENCY_REPLAY_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_IDEMPOTENCY_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_KILL_SWITCH_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_KILL_SWITCH_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_MANUAL_REVIEW_GATE_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_GATE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_MANUAL_RUN_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_MANUAL_RUN_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_OUTCOME_BINDING_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_OUTCOME_BINDING_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_OUTPUT_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_OUTPUT_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_OWNER_DECISION_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_OWNER_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_REPLAY_VALIDATION_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_REPLAY_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    DEFAULT_SMOKE_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_SMOKE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    MODE as HIGH_INTENSITY_PAPER_SHADOW_MODE,
)
from ai_trading_system.high_intensity_risk_cap_paper_shadow_scope_plan import (
    run_high_intensity_risk_cap_observe_only_paper_shadow_scope_plan,
)
...
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
    DEFAULT_DOCS_ROOT as DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_DOCS_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
    DEFAULT_DYNAMIC_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_DYNAMIC_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
    DEFAULT_EVENT_LOGGER_ROOT as DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_EVENT_LOGGER_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
    DEFAULT_FORWARD_OBSERVE_PLAN_ROOT as DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_PLAN_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
    DEFAULT_OUTPUT_ROOT as DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_OUTPUT_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
    DEFAULT_RUNTIME_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_RUNTIME_DRY_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
    DEFAULT_RUNTIME_INTEGRATION_PLAN_ROOT as DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_RUNTIME_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
    DEFAULT_SCHEDULER_INTEGRATION_PLAN_ROOT as DEFAULT_HIGH_INTENSITY_DRY_RUN_SCHEDULER_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
    DEFAULT_THRESHOLD_SELECTION_ROOT as DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_THRESHOLD_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
    MODE as HIGH_INTENSITY_SCHEDULER_DRY_RUN_MODE,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_dry_run import (
...
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
    DEFAULT_AUDIT_PACKAGE_ROOT as DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_AUDIT_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
    DEFAULT_DISABLED_WIRING_ROOT as DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_DISABLED_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
    DEFAULT_DOCS_ROOT as DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_DOCS_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
    DEFAULT_MANUAL_REVIEW_GATE_ROOT as DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_GATE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
    DEFAULT_MANUAL_RUN_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_MANUAL_RUN_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
    DEFAULT_OUTPUT_ROOT as DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_OUTPUT_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
    DEFAULT_OWNER_DECISION_ROOT as DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_OWNER_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
    DEFAULT_REPLAY_VALIDATION_ROOT as DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_REPLAY_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
    DEFAULT_SMOKE_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_SMOKE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
    MODE as HIGH_INTENSITY_GAP_CLOSURE_MODE,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_gap_closure_plan import (
...
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_AUDIT_PACKAGE_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_AUDIT_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_DISABLED_WIRING_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_DISABLED_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_DOCS_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_DOCS_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_GAP_CLOSURE_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_GAP_CLOSURE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_HARDENING_BACKLOG_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_HARDENING_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_KILL_SWITCH_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_KILL_SWITCH_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_MANUAL_REVIEW_GATE_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_GATE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_MANUAL_RUN_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_MANUAL_RUN_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_OUTPUT_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_OUTPUT_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_OWNER_DECISION_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_OWNER_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_REPLAY_VALIDATION_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_REPLAY_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    DEFAULT_SMOKE_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_SMOKE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
    MODE as HIGH_INTENSITY_IDEMPOTENCY_MODE,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_idempotency_replay_contract_plan import (
...
from ai_trading_system.high_intensity_risk_cap_scheduler_manual_run_dry_run import (
    DEFAULT_DISABLED_WIRING_ROOT as DEFAULT_HIGH_INTENSITY_MANUAL_RUN_DRY_RUN_DISABLED_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_manual_run_dry_run import (
    DEFAULT_DOCS_ROOT as DEFAULT_HIGH_INTENSITY_MANUAL_RUN_DRY_RUN_DOCS_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_manual_run_dry_run import (
    DEFAULT_MANUAL_REVIEW_GATE_ROOT as DEFAULT_HIGH_INTENSITY_MANUAL_RUN_DRY_RUN_GATE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_manual_run_dry_run import (
    DEFAULT_OUTPUT_ROOT as DEFAULT_HIGH_INTENSITY_MANUAL_RUN_DRY_RUN_OUTPUT_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_manual_run_dry_run import (
    DEFAULT_SMOKE_DRY_RUN_ROOT as DEFAULT_HIGH_INTENSITY_MANUAL_RUN_DRY_RUN_SMOKE_ROOT,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_manual_run_dry_run import (
    MODE as HIGH_INTENSITY_MANUAL_RUN_DRY_RUN_MODE,
)
from ai_trading_system.high_intensity_risk_cap_scheduler_manual_run_dry_run import (
...
@trends_app.command("dynamic-target-baseline-source-remediation")
def dynamic_target_baseline_source_remediation_command(
    ...
    output_dir: Annotated[
        Path, typer.Option("--output-dir")
    ] = DEFAULT_DYNAMIC_TARGET_SOURCE_REMEDIATION_OUTPUT_ROOT,
    docs_root: Annotated[
        Path, typer.Option("--docs-root")
    ] = DEFAULT_DYNAMIC_TARGET_SOURCE_REMEDIATION_DOCS_ROOT,
    mode: Annotated[str, typer.Option("--mode")] = DYNAMIC_TARGET_SOURCE_REMEDIATION_MODE,
) -> None:
    payload = run_dynamic_target_baseline_source_remediation(
...
@trends_app.command("high-intensity-risk-cap-forward-outcome-review")
def high_intensity_risk_cap_forward_outcome_review_command(
    partial_readiness_dir: Annotated[
        Path, typer.Option("--partial-readiness-dir")
    ] = DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_PARTIAL_ROOT,
    outcome_binder_dir: Annotated[
        Path, typer.Option("--outcome-binder-dir")
    ] = DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_BINDER_ROOT,
    event_logger_dir: Annotated[
        Path, typer.Option("--event-logger-dir")
    ] = DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_EVENT_LOGGER_ROOT,
    threshold_selection_dir: Annotated[
        Path, typer.Option("--threshold-selection-dir")
    ] = DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_THRESHOLD_ROOT,
    forward_observe_plan_dir: Annotated[
        Path, typer.Option("--forward-observe-plan-dir")
    ] = DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_PLAN_ROOT,
    output_dir: Annotated[
        Path, typer.Option("--output-dir")
    ] = DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_OUTPUT_ROOT,
    docs_root: Annotated[
        Path, typer.Option("--docs-root")
    ] = DEFAULT_HIGH_INTENSITY_FORWARD_OUTCOME_DOCS_ROOT,
    mode: Annotated[str, typer.Option("--mode")] = HIGH_INTENSITY_FORWARD_OUTCOME_MODE,
) -> None:
    payload = run_high_intensity_risk_cap_forward_outcome_review(
...
@trends_app.command("high-intensity-risk-cap-observe-only-scheduler-dry-run")
def high_intensity_risk_cap_observe_only_scheduler_dry_run_command(
    scheduler_integration_plan_dir: Annotated[
        Path, typer.Option("--scheduler-integration-plan-dir")
    ] = DEFAULT_HIGH_INTENSITY_DRY_RUN_SCHEDULER_ROOT,
    runtime_dry_run_dir: Annotated[
        Path, typer.Option("--runtime-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_RUNTIME_DRY_ROOT,
    runtime_integration_plan_dir: Annotated[
        Path, typer.Option("--runtime-integration-plan-dir")
    ] = DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_RUNTIME_ROOT,
    continue_decision_dir: Annotated[
        Path, typer.Option("--continue-decision-dir")
    ] = DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_CONTINUE_ROOT,
    event_logger_dir: Annotated[
        Path, typer.Option("--event-logger-dir")
    ] = DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_EVENT_LOGGER_ROOT,
    threshold_selection_dir: Annotated[
        Path, typer.Option("--threshold-selection-dir")
    ] = DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_THRESHOLD_ROOT,
    forward_observe_plan_dir: Annotated[
        Path, typer.Option("--forward-observe-plan-dir")
    ] = DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_PLAN_ROOT,
    dynamic_dry_run_dir: Annotated[
        Path, typer.Option("--dynamic-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_DYNAMIC_ROOT,
    output_dir: Annotated[
        Path, typer.Option("--output-dir")
    ] = DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_OUTPUT_ROOT,
    docs_root: Annotated[
        Path, typer.Option("--docs-root")
    ] = DEFAULT_HIGH_INTENSITY_SCHEDULER_DRY_RUN_DOCS_ROOT,
    mode: Annotated[str, typer.Option("--mode")] = HIGH_INTENSITY_SCHEDULER_DRY_RUN_MODE,
) -> None:
    payload = run_high_intensity_risk_cap_observe_only_scheduler_dry_run(
...
def high_intensity_risk_cap_observe_only_scheduler_manual_run_dry_run_command(
    disabled_wiring_dir: Annotated[
        Path, typer.Option("--disabled-wiring-dir")
    ] = DEFAULT_HIGH_INTENSITY_MANUAL_RUN_DRY_RUN_DISABLED_ROOT,
    smoke_dry_run_dir: Annotated[
        Path, typer.Option("--smoke-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_MANUAL_RUN_DRY_RUN_SMOKE_ROOT,
    manual_review_gate_dir: Annotated[
        Path, typer.Option("--manual-review-gate-dir")
    ] = DEFAULT_HIGH_INTENSITY_MANUAL_RUN_DRY_RUN_GATE_ROOT,
    output_dir: Annotated[
        Path, typer.Option("--output-dir")
    ] = DEFAULT_HIGH_INTENSITY_MANUAL_RUN_DRY_RUN_OUTPUT_ROOT,
    docs_root: Annotated[
        Path, typer.Option("--docs-root")
...
def high_intensity_risk_cap_observe_only_scheduler_gap_closure_plan_command(
    disabled_wiring_dir: Annotated[
        Path, typer.Option("--disabled-wiring-dir")
    ] = DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_DISABLED_ROOT,
    smoke_dry_run_dir: Annotated[
        Path, typer.Option("--smoke-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_SMOKE_ROOT,
    manual_review_gate_dir: Annotated[
        Path, typer.Option("--manual-review-gate-dir")
    ] = DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_GATE_ROOT,
    manual_run_dry_run_dir: Annotated[
        Path, typer.Option("--manual-run-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_MANUAL_RUN_ROOT,
    replay_validation_dir: Annotated[
        Path, typer.Option("--replay-validation-dir")
    ] = DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_REPLAY_ROOT,
    audit_package_dir: Annotated[
        Path, typer.Option("--audit-package-dir")
    ] = DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_AUDIT_ROOT,
    owner_decision_dir: Annotated[
        Path, typer.Option("--owner-decision-dir")
    ] = DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_OWNER_ROOT,
    output_dir: Annotated[
        Path, typer.Option("--output-dir")
    ] = DEFAULT_HIGH_INTENSITY_GAP_CLOSURE_OUTPUT_ROOT,
    docs_root: Annotated[
        Path, typer.Option("--docs-root")
...
def high_intensity_risk_cap_observe_only_scheduler_idempotency_replay_contract_plan_command(
    disabled_wiring_dir: Annotated[
        Path, typer.Option("--disabled-wiring-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_DISABLED_ROOT,
    smoke_dry_run_dir: Annotated[
        Path, typer.Option("--smoke-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_SMOKE_ROOT,
    manual_review_gate_dir: Annotated[
        Path, typer.Option("--manual-review-gate-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_GATE_ROOT,
    manual_run_dry_run_dir: Annotated[
        Path, typer.Option("--manual-run-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_MANUAL_RUN_ROOT,
    replay_validation_dir: Annotated[
        Path, typer.Option("--replay-validation-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_REPLAY_ROOT,
    audit_package_dir: Annotated[
        Path, typer.Option("--audit-package-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_AUDIT_ROOT,
    owner_decision_dir: Annotated[
        Path, typer.Option("--owner-decision-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_OWNER_ROOT,
    gap_closure_dir: Annotated[
        Path, typer.Option("--gap-closure-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_GAP_CLOSURE_ROOT,
    hardening_backlog_dir: Annotated[
        Path, typer.Option("--hardening-backlog-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_HARDENING_ROOT,
    kill_switch_dir: Annotated[
        Path, typer.Option("--kill-switch-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_KILL_SWITCH_ROOT,
    output_dir: Annotated[
        Path, typer.Option("--output-dir")
    ] = DEFAULT_HIGH_INTENSITY_IDEMPOTENCY_OUTPUT_ROOT,
    docs_root: Annotated[
        Path, typer.Option("--docs-root")
...
def high_intensity_risk_cap_observe_only_outcome_binding_contract_plan_command(
    disabled_wiring_dir: Annotated[
        Path, typer.Option("--disabled-wiring-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_DISABLED_ROOT,
    smoke_dry_run_dir: Annotated[
        Path, typer.Option("--smoke-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_SMOKE_ROOT,
    manual_review_gate_dir: Annotated[
        Path, typer.Option("--manual-review-gate-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_GATE_ROOT,
    manual_run_dry_run_dir: Annotated[
        Path, typer.Option("--manual-run-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_MANUAL_RUN_ROOT,
    replay_validation_dir: Annotated[
        Path, typer.Option("--replay-validation-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_REPLAY_ROOT,
    audit_package_dir: Annotated[
        Path, typer.Option("--audit-package-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_AUDIT_ROOT,
    owner_decision_dir: Annotated[
        Path, typer.Option("--owner-decision-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_OWNER_ROOT,
    gap_closure_dir: Annotated[
        Path, typer.Option("--gap-closure-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_GAP_CLOSURE_ROOT,
    hardening_backlog_dir: Annotated[
        Path, typer.Option("--hardening-backlog-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_HARDENING_ROOT,
    kill_switch_dir: Annotated[
        Path, typer.Option("--kill-switch-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_KILL_SWITCH_ROOT,
    idempotency_replay_dir: Annotated[
        Path, typer.Option("--idempotency-replay-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_IDEMPOTENCY_ROOT,
    event_append_dir: Annotated[
        Path, typer.Option("--event-append-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_EVENT_APPEND_ROOT,
    output_dir: Annotated[
        Path, typer.Option("--output-dir")
    ] = DEFAULT_HIGH_INTENSITY_OUTCOME_BINDING_OUTPUT_ROOT,
    docs_root: Annotated[
        Path, typer.Option("--docs-root")
...
@trends_app.command("high-intensity-risk-cap-observe-only-paper-shadow-scope-plan")
def high_intensity_risk_cap_observe_only_paper_shadow_scope_plan_command(
    disabled_wiring_dir: Annotated[
        Path, typer.Option("--disabled-wiring-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_DISABLED_ROOT,
    smoke_dry_run_dir: Annotated[
        Path, typer.Option("--smoke-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_SMOKE_ROOT,
    manual_review_gate_dir: Annotated[
        Path, typer.Option("--manual-review-gate-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_GATE_ROOT,
    manual_run_dry_run_dir: Annotated[
        Path, typer.Option("--manual-run-dry-run-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_MANUAL_RUN_ROOT,
    replay_validation_dir: Annotated[
        Path, typer.Option("--replay-validation-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_REPLAY_ROOT,
    audit_package_dir: Annotated[
        Path, typer.Option("--audit-package-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_AUDIT_ROOT,
    owner_decision_dir: Annotated[
        Path, typer.Option("--owner-decision-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_OWNER_ROOT,
    gap_closure_dir: Annotated[
        Path, typer.Option("--gap-closure-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_GAP_CLOSURE_ROOT,
    hardening_backlog_dir: Annotated[
        Path, typer.Option("--hardening-backlog-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_HARDENING_ROOT,
    kill_switch_dir: Annotated[
        Path, typer.Option("--kill-switch-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_KILL_SWITCH_ROOT,
    idempotency_replay_dir: Annotated[
        Path, typer.Option("--idempotency-replay-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_IDEMPOTENCY_ROOT,
    event_append_dir: Annotated[
        Path, typer.Option("--event-append-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_EVENT_APPEND_ROOT,
    outcome_binding_dir: Annotated[
        Path, typer.Option("--outcome-binding-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_OUTCOME_BINDING_ROOT,
    output_dir: Annotated[
        Path, typer.Option("--output-dir")
    ] = DEFAULT_HIGH_INTENSITY_PAPER_SHADOW_OUTPUT_ROOT,
    docs_root: Annotated[
        Path, typer.Option("--docs-root")
