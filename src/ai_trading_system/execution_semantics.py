...
EXECUTION_SEMANTICS_REPORT_SPECS: tuple[dict[str, str], ...] = (
    ...
    {
        "report_id": "dynamic_strategy_research_only_shadow_observation_protocol",
        "title": "Dynamic Strategy Research-Only Shadow Observation Protocol",
        "command": (
    ...
    {
        "report_id": "dynamic_strategy_research_only_observation_log_schema_plan",
        "title": "Dynamic Strategy Research-Only Observation Log Schema And Report Plan",
        "command": (
            "aits research strategies "
    ...
    {
        "report_id": "dynamic_strategy_research_only_observation_report_dry_run",
        "title": "Dynamic Strategy Research-Only Observation Report Dry-Run",
        "command": (
            "aits research strategies "
    ...
    {
        "report_id": (
            "dynamic_strategy_research_only_observation_owner_reassessment"
        ),
        "title": (
