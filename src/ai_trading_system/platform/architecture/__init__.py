...
from ai_trading_system.platform.architecture.checkout_guard import (
    CHECKOUT_DECISION_SCHEMA_VERSION,
    CHECKOUT_GUARD_POLICY_SCHEMA_VERSION,
...
from ai_trading_system.platform.architecture.checkout_telemetry import (
    ...
    CHECKOUT_TELEMETRY_ROLLUP_SCHEMA_VERSION,
    CHECKOUT_TELEMETRY_SNAPSHOT_SCHEMA_VERSION,
